...
<div class="row">
            <div class="col-lg-12">
                <h4>NOTE</h4>
                <p>  After you find a potential donor, pls contact VitalFlow on the details of where you want the blood to be delivered.<br>Our team
                  will make sure it reaches your destination within the shortest time possible. Our details are mentioned in the Contact Us Page
                </p>
  ...
  $result=mysqli_query($conn,$sql) or die("query unsuccessful.");
    ...
    while($row = mysqli_fetch_assoc($result)) {
      ...
      <div class="card" style="width:300px">
          <img class="card-img-top" src="bloodcard.jpg" alt="Card image" style="width:100%;height:300px">
          <div class="card-body">
